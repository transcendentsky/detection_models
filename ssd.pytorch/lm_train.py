...
def train():
    ...
    criterion = MultiBoxLoss(cfg['num_classes'], 0.5, True, 0, True, 3, 0.5,
                             False, args.cuda, lm=True)
    sche = lr_scheduler.CosineAnnealingLR(optimizer, T_max=250)

    # initSummaty()
    log_folder = './results/' + net.__class__.__name__ + '/' + optimizer.__class__.__name__ + '/' + 'lm/' + str(1001) + '/'
    ...
    for epoch in range(args.start_iter, 250):
        ...
        if epoch % 10 == 0:
            ...
            torch.save(ssd_net.state_dict(), 'weights/lm/ssd300_' + args.dataset + '_' +
                       repr(epoch) + '.pth')
